      ...
      in {
        packages = {
          ...
          in pkgs.writeScriptBin "galois-benchmark" ''
            ...
            generateConstraints stats = toFile def "constraints.png" $ do
            ...
            generateCoefficients stats = toFile def "coefficients.png" $ do
            ...
            generateInputs stats = toFile def "inputs.png" $ do
            ...
            generatePK stats = toFile def "pk.png" $ do
            ...
            generateVK stats = toFile def "vk.png" $ do
            ...
            generatePublicWitness stats = toFile def "witness.png" $ do
              layout_title .= "Verifying Key Points"
